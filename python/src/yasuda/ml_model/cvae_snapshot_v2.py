...
class CVaeSnapshotVer02(nn.Module):
    def __init__(
        self,
        *,
        ...
        **kwargs,
        ...
        super(CVaeSnapshotVer02, self).__init__()
        ...
        self.is_skipped_globally = is_skipped_globally
